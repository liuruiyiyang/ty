...
public class CharTransfer extends ITransfer {
...
//						.recordWorkStatus(new WorkStatus(deviceId, workStatusId, timestamp, "char", value));
		} catch (NumberFormatException e) {
			System.out.println("[Char转换Error] （设备号： " + deviceId + ",工况号：" + workStatusId + ")");
			e.printStackTrace();
		}
	}
