...
public class FloatTransfer extends ITransfer {
...
//						.recordWorkStatus(new WorkStatus(deviceId, workStatusId, timestamp, "float", v + ""));
		} catch (NumberFormatException e) {
			System.out.println("[Float转换Error] （设备号： " + deviceId + ",工况号：" + workStatusId + ")");
			e.printStackTrace();
		}
