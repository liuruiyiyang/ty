...
public class DoubleTransfer extends ITransfer {
...
//						.recordWorkStatus(new WorkStatus(deviceId, workStatusId, timestamp, "double", v + ""));
		} catch (NumberFormatException e) {
			System.out.println("[Double转换Error] （设备号： " + deviceId + ",工况号：" + workStatusId + ")");
			e.printStackTrace();
		}
	}
